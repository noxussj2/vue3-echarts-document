const e = ['nick', 'mail', 'link'],
    ...
    r = 'en-US',
    l = [
        '/images/tieba_agree.png',
        '/images/tieba_look_down.png',
        '/images/tieba_sunglasses.png',
        '/images/tieba_pick_nose.png',
        '/images/tieba_awkward.png',
        '/images/tieba_sleep.png'
    ],
    i = (e) =>
        new Promise((t, n) => {
    ...
    o = (e) => {
        const t = async (t, n = {}) =>
            fetch(
                ...
                .then((e) => e.json())
                .then(({ data: e }) => e.map((e) => ({ title: e.title, src: e.images.downsized_medium.url })))
        return { search: (e) => t('search', { q: e, offset: '0' }), default: () => t('trending', {}), more: (e, n = 0) => t('search', { q: e, offset: n.toString() }) }
    },
    a = new RegExp(
        `(${/[\u4E00-\u9FFF\u3400-\u4dbf\uf900-\ufaff\u3040-\u309f\uac00-\ud7af\u0400-\u04FF]+|\w+/.source}|${/</.source})|((?:${/(?:^|\s)\/\/(.+?)$/gm.source})|(?:${
            /\/\*([\S\s]*?)\*\//gm.source
        }))`,
        'gmi'
    ),
...
const k = {
    ...
    _ = ({ serverURL: e, lang: t, paths: n, type: r, signal: l }) =>
        fetch(`${e}/article?path=${encodeURIComponent(n.join(','))}&type=${encodeURIComponent(r.join(','))}&lang=${t}`, { signal: l }).then((e) => e.json()),
    $ = ({ serverURL: e, lang: t, path: n, type: r, action: l }) =>
        fetch(`${e}/article?lang=${t}`, { method: 'POST', headers: b, body: JSON.stringify({ path: n, type: r, action: l }) }).then((e) => e.json()),
    C = ({ serverURL: e, lang: t, token: n, objectId: r, comment: l }) =>
        fetch(`${e}/comment/${r}?lang=${t}`, { method: 'PUT', headers: { ...b, Authorization: `Bearer ${n}` }, body: JSON.stringify(l) })
            .then((e) => e.json())
...
const Ie = (e) => (Y(e) ? e : null == e ? '' : K(e) || (te(e) && (e.toString === re || !X(e.toString))) ? JSON.stringify(e, Te, 2) : String(e)),
    Te = (e, t) =>
        t && t.__v_isRef
            ? Te(e, t.value)
            : G(t)
                ...
                ((e) => {
                    ...
                    if (t.length) {
                        ...
                        for (let r = 0; r < t.length; r++) {
                            const l = t[r]
                            Pe(l) && !Fe(l) ? l.delete(e) : (t[n++] = l), (l.w &= ~De), (l.n &= ~De)
                        }
                        t.length = n
                    }
                })(this),
...
function et(e, t) {
    let n = !1
    Ne <= He ? Fe(e) || ((e.n |= De), (n = !Pe(e))) : (n = !e.has(Be)), n && (e.add(Be), Be.deps.push(e))
}
...
function dt(e = !1, t = !1) {
    return function (n, r, l) {
        ...
        if ('__v_raw' === r && l === (e ? (t ? Nt : Vt) : t ? Ft : Pt).get(n)) return n
        const i = K(n)
        if (!e) {
...
function hn(e, t, n, r = !0) {
    ...
    if (t) {
        ...
        for (; r; ) {
            const t = r.ec
            if (t) for (let n = 0; n < t.length; n++) if (!1 === t[n](e, l, i)) return
            r = r.parent
        }
...
function An(e) {
    if (yn.length) {
        ...
        for (wn = e, wn.sort((e, t) => Rn(e) - Rn(t)), kn = 0; kn < wn.length; kn++) wn[kn]()
        ;(wn = null), (kn = 0)
    }
}
...
function Tn(e, t) {
    return !(!e || !D(t)) && ((t = t.slice(2).replace(/Once$/, '')), Z(e, t[0].toLowerCase() + t.slice(1)) || Z(e, he(t)) || Z(e, t))
}
let jn = null,
    On = null
function Un(e) {
...
function Mn(e) {
    ...
    try {
        if (4 & n.shapeFlag) {
            ...
            const e = t
            ;(m = pl(e.length > 1 ? e(i, { attrs: a, slots: o, emit: c }) : e(i, null))), (v = t.props ? a : Pn(a))
        }
    } catch (t) {
    ...
    return n.dirs && ((w = al(w)), (w.dirs = w.dirs ? w.dirs.concat(n.dirs) : n.dirs)), n.transition && (w.transition = n.transition), (m = w), Un(y), m
}
const Pn = (e) => {
        let t
...
function Bn(e, t, { immediate: n, deep: r, flush: l, onTrack: i, onTrigger: s } = M) {
    var o
    ...
    if (
        (tn(e)
            ...
            ? ((c = () => e), (r = !0))
            : K(e)
            ? ((d = !0), (p = e.some((e) => Wt(e) || Zt(e))), (c = () => e.map((e) => (tn(e) ? e.value : Wt(e) ? Wn(e) : X(e) ? pn(e, a, 2) : void 0))))
            : (c = X(e)
                  ? t
                      ? () => pn(e, a, 2)
                      : () => {
...
function qn(e, t) {
    ...
    for (let e = 0; e < t.length; e++) {
        let [n, i, s, o = M] = t[e]
        n && (X(n) && (n = { mounted: n, updated: n }), n.deep && Wn(i), l.push({ dir: n, instance: r, value: i, oldValue: void 0, arg: s, modifiers: o }))
    }
    return e
}
function Zn(e, t, n, r) {
...
const sr = (e) => (e ? ($l(e) ? El(e) || e.proxy : sr(e.parent)) : null),
    ...
    cr = {
        get({ _: e }, t) {
            const { ctx: n, setupState: r, data: l, props: i, accessCache: s, type: o, appContext: a } = e
            let c
            if ('$' !== t[0]) {
                const o = s[t]
                if (void 0 !== o)
        ...
        set({ _: e }, t, n) {
            ...
            return ar(l, t) ? ((l[t] = n), !0) : r !== M && Z(r, t) ? ((r[t] = n), !0) : !Z(e.props, t) && ('$' !== t[0] || !(t.slice(1) in e)) && ((i[t] = n), !0)
        },
        has({ _: { data: e, setupState: t, accessCache: n, ctx: r, appContext: l, propsOptions: i } }, s) {
            let o
            return !!n[s] || (e !== M && Z(e, s)) || ar(t, s) || ((o = i[0]) && Z(o, s)) || Z(r, s) || Z(or, s) || Z(l.config.globalProperties, s)
        },
...
function yr() {
    return {
        app: null,
        config: { isNativeTag: V, performance: !1, globalProperties: {}, optionMergeStrategies: {}, errorHandler: void 0, warnHandler: void 0, compilerOptions: {} },
        mixins: [],
        components: {},
        directives: {},
...
function xr(e, t, n = !1) {
    const r = vl || jn
    if (r || br) {
        const l = r ? (null == r.parent ? r.vnode.appContext && r.vnode.appContext.provides : r.parent.provides) : br._context.provides
        ...
        for (let a in t) {
            ...
            l && Z(l, (u = pe(a)))
                ? i && i.includes(u)
                    ? ((s || (s = {}))[u] = c)
                    : (n[u] = c)
                : Tn(e.emitsOptions, a) || (a in r && c === r[a]) || ((r[a] = c), (o = !0))
        }
    if (i) {
        const t = Gt(n),
            r = s || M
...
const Lr = (e) => '_' === e[0] || '$stable' === e,
    ...
    Mr = (e, t, n) => {
        ...
        if (32 & r.shapeFlag) {
            const e = t._
            e ? (n && 1 === e ? (i = !1) : (B(l, t), n || 1 !== e || delete l._)) : ((i = !t.$stable), jr(t, l)), (s = t)
        } else t && (Or(e, t), (s = { default: 1 }))
        if (i) for (const e in l) Lr(e) || e in s || delete l[e]
    }
function Pr(e, t, n, r, l = !1) {
    if (K(e)) return void e.forEach((e, i) => Pr(e, t && (K(t) ? t[i] : t), n, r, l))
    if (Gn(r) && !l) return
...
const Fr = function (e, t) {
    ...
    t && t.pendingBranch
        ? K(e)
            ? t.effects.push(...e)
            : t.effects.push(e)
        : (K((n = e)) ? yn.push(...n) : (wn && wn.includes(n, n.allowRecurse ? kn + 1 : kn)) || yn.push(n), Cn())
}
function Vr(e) {
    return (function (e, t) {
        be().__VUE__ = !0
        const {
            ...
            f = (e, t, n, r = null, l = null, i = null, s = !1, o = null, a = !!t.dynamicChildren) => {
                if (e === t) return
                ...
                switch (c) {
                    ...
                    case Hr:
                        ...
                        break
                    default:
                        1 & p ? k(e, t, n, r, l, i, s, o, a) : 6 & p ? R(e, t, n, r, l, i, s, o, a) : (64 & p || 128 & p) && c.process(e, t, n, r, l, i, s, o, a, K)
                }
            ...
            k = (e, t, n, r, l, i, s, o, a) => {
                ;(s = s || 'svg' === t.type), null == e ? b(t, n, r, l, i, s, o, a) : $(e, t, l, i, s, o, a)
            },
            b = (e, t, r, s, o, a, u, p) => {
                let d, h
                ...
                if (
                    ...
                    8 & m ? c(d, e.children) : 16 & m && _(e.children, d, null, s, o, a && 'foreignObject' !== f, u, p),
            ...
            $ = (e, t, n, r, i, s, o) => {
                ...
                if ((p ? C(e.dynamicChildren, p, a, n, r, m, s) : o || T(e, t, a, null, n, r, m, s, !1), u > 0)) {
            ...
            S = (e, t, n, r, i, s, o) => {
                if (n !== r) {
                    if (n !== M) for (const a in n) ae(a) || a in r || l(e, a, n[a], null, o, t.children, i, s, B)
                    for (const a in r) {
                        if (ae(a)) continue
                        const c = r[a],
                            u = n[a]
            ...
            A = (e, t, r, l, i, o, a, c, u) => {
                ...
                g && (c = c ? c.concat(g) : g),
                    null == e
                        ...
                        ? (C(e.dynamicChildren, f, r, i, o, a, c), (null != t.key || (i && t === i.subTree)) && Dr(e, t, !0))
                        : T(e, t, r, d, i, o, a, c, u)
            },
            R = (e, t, n, r, l, i, s, o, a) => {
            ...
            E = (e, t, n, r, l, i, s) => {
                const o = (e.component = (function (e, t, n) {
                    ...
                    ;(i.ctx = { _: i }), (i.root = t ? t.root : i), (i.emit = Ln.bind(null, i)), e.ce && e.ce(i)
                    return i
                })(e, r, l))
                if (
                                          ...
                                          r.length > 1
                                              ? (function (e) {
                                                    ...
                                                    return {
                                                        get attrs() {
                                                            return (function (e) {
                                                                return e.attrsProxy || (e.attrsProxy = new Proxy(e.attrs, { get: (t, n) => (Ye(e, 0, '$attrs'), t[n]) }))
                                                            })(e)
                                                        },
                                                        slots: e.slots,
                                                        emit: e.emit,
                ...
                const o = () => {
                        if (e.isMounted) {
                            ...
                            ;(e.subTree = d),
                                ...
                                o && Fr(o, l),
                                (t = n.props && n.props.onVnodeUpdated) && Fr(() => fl(t, a, n, c), l)
                        } else {
                            let s
                        ...
                        if (!(r || s > 0) || 16 & s) {
                            ...
                            for (const i in o)
                                (t && (Z(t, i) || ((r = he(i)) !== i && Z(t, r)))) ||
                                    (a ? !n || (void 0 === n[i] && void 0 === n[r]) || (l[i] = Cr(a, o, i, void 0, e, !0)) : delete l[i])
                            if (i !== o) for (const e in i) (t && Z(t, e)) || (delete i[e], (c = !0))
                        } else if (8 & s) {
            ...
            O = (e, t, n, r, l, i, s, o, a) => {
                ...
                if (c > p) {
                    ...
                    for (c = h; c <= p; c++) {
                        ...
                        void 0 === u ? V(r, l, i, !0) : ((x[u - g] = c + 1), u >= b ? (b = u) : (k = !0), f(r, t[u], n, null, l, i, s, o, a), y++)
                    }
                    const _ = k
                        ? (function (e) {
                              const t = e.slice(),
                    ...
                    for (v = _.length - 1, c = w - 1; c >= 0; c--) {
                        const e = g + c,
                            p = t[e],
                            d = e + 1 < u ? t[e + 1].el : r
                        0 === x[c] ? f(null, p, n, d, l, i, s, o, a) : k && (v < 0 || c !== _[v] ? U(p, n, d, 2) : v--)
                    }
                }
            },
            U = (e, t, r, l, i = null) => {
            ...
            V = (e, t, n, r = !1, l = !1) => {
                const { type: i, props: s, ref: o, children: a, dynamicChildren: c, shapeFlag: u, patchFlag: p, dirs: d } = e
                if ((null != o && Pr(o, null, n, e, !0), 256 & u)) return void t.ctx.deactivate(e)
                const h = 1 & u && d,
                    f = !Gn(e)
                let g
            ...
            W = (e) => (6 & e.shapeFlag ? W(e.component.subTree) : 128 & e.shapeFlag ? e.suspense.next() : p(e.anchor || e.el)),
            q = (e, t, n) => {
...
function Dr(e, t, n = !1) {
    ...
    if (K(r) && K(l))
        for (let e = 0; e < r.length; e++) {
            const t = r[e]
            let i = l[e]
            1 & i.shapeFlag && !i.dynamicChildren && ((i.patchFlag <= 0 || 32 === i.patchFlag) && ((i = l[e] = dl(l[e])), (i.el = t.el)), n || Dr(t, i)),
                i.type === Br && (i.el = t.el)
        }
}
...
function Xr(e) {
    return (e.dynamicChildren = Qr > 0 ? Kr || P : null), Zr.pop(), (Kr = Zr[Zr.length - 1] || null), Qr > 0 && Kr && Kr.push(e), e
}
...
const rl = '__vInternal',
    ...
    il = ({ ref: e, ref_key: t, ref_for: n }) => ('number' == typeof e && (e = '' + e), null != e ? (Y(e) || tn(e) || X(e) ? { i: jn, r: e, k: t, f: !!n } : e) : null)
function sl(e, t = null, n = null, r = 0, l = null, i = e === Hr ? 0 : 1, s = !1, o = !1) {
    ...
    return (
        o ? (hl(a, n), 128 & i && e.normalize(a)) : n && (a.shapeFlag |= Y(n) ? 8 : 16),
        Qr > 0 && !s && Kr && (a.patchFlag > 0 || 6 & i) && 32 !== a.patchFlag && Kr.push(a),
        a
    )
}
...
function hl(e, t) {
    ...
    if (null == t) t = null
        ...
        }
        {
            n = 32
            const r = t._
            r || rl in t ? 3 === r && jn && (1 === jn.slots._ ? (t._ = 1) : ((t._ = 2), (e.patchFlag |= 1024))) : (t._ctx = jn)
        }
    } else X(t) ? ((t = { default: t, _ctx: jn }), (n = 32)) : ((t = String(t)), 64 & r ? ((n = 16), (t = [cl(t)])) : (n = 8))
...
function El(e) {
    if (e.exposed)
        return (
            e.exposeProxy ||
            (e.exposeProxy = new Proxy(cn(Qt(e.exposed)), { get: (t, n) => (n in t ? t[n] : n in or ? or[n](e) : void 0), has: (e, t) => t in e || t in or }))
        )
}
const zl = (e, t) =>
    (function (e, t, n = !1) {
    ...
    return 2 === r
        ? te(t) && !K(t)
            ? tl(t)
                ...
                : ol(e, t)
            : ol(e, null, t)
        : (r > 3 ? (n = Array.prototype.slice.call(arguments, 2)) : 3 === r && tl(n) && (n = [n]), ol(e, t, n))
}
const Il = Symbol.for('v-scx'),
    ...
    Ml = {
        ...
        createElement: (e, t, n, r) => {
            const l = t ? Ol.createElementNS('http://www.w3.org/2000/svg', e) : Ol.createElement(e, n ? { is: n } : void 0)
...
function Fl(e, t, n) {
    if (K(n)) n.forEach((n) => Fl(e, t, n))
        ...
        Pl.test(n) ? e.setProperty(he(r), n.replace(Pl, ''), 'important') : (e[r] = n)
    }
}
...
const Yl = {
        ...
        beforeUpdate(e, { value: t, modifiers: { lazy: n, trim: r, number: l } }, i) {
...
const ni = {
    ...
    ri = {
        ...
        created(e, { value: t, modifiers: { number: n } }, r) {
            const l = Q(t)
            Hl(e, 'change', () => {
                const t = Array.prototype.filter.call(e.options, (e) => e.selected).map((e) => (n ? we(ii(e)) : ii(e)))
...
function Ri(...e) {
    let t, n, r, l
    if (('string' == typeof e[0] || Array.isArray(e[0]) ? (([n, r, l] = e), (t = Si)) : ([t, n, r, l] = e), !t)) return wi
    ...
    const i = [],
        ...
        o = Hn(
            ...
            ([e, t]) => {
                if ((s(), !e)) return
                const l = yi(t) ? { ...t } : t
                i.push(...n.flatMap((t) => r.map((n) => ((e, t, n, r) => (e.addEventListener(t, n, r), () => e.removeEventListener(t, n, r)))(e, t, n, l))))
            },
                ...
                (function (t) {
                    try {
                        if (null == t) n.removeItem(e)
                            ...
                            const r = v.write(t),
                                l = n.getItem(e)
                            l !== r && (n.setItem(e, r), p && p.dispatchEvent(new CustomEvent(ji, { detail: { key: e, oldValue: l, newValue: r, storageArea: n } })))
                        }
                    } catch (e) {
                        h(e)
                    }
                ...
                try {
                    ;(null == t ? void 0 : t.newValue) !== v.write(f.value) &&
                        (f.value = (function (t) {
                            ...
                            if (!t && c) {
                                const e = v.read(r)
                                return 'function' == typeof c ? c(e, g) : 'object' !== m || Array.isArray(e) ? e : { ...g, ...e }
                            }
            ...
            'requestAnimationFrame' === n
                ? (function (e, t = {}) {
                      ...
                      let i = 0,
                          s = null
                      function o(t) {
                          l.value && r && (e({ delta: t - (i || t), timestamp: t }), (i = t), (s = r.requestAnimationFrame(o)))
                      }
                      function a() {
...
function Mi(e, t = wi, n = {}) {
                    ...
                    new Promise((r, l) => {
                        ...
                        m
                            ...
                            : ((m = p.createElement('script')),
                              ...
                              Object.entries(d).forEach(([e, t]) => (null == m ? void 0 : m.setAttribute(e, t))),
                              (g = !0)),
    ...
    var v
    return r && !l && $i(g), l || ((v = m), yl() && er(v)), { scriptTag: h, load: g, unload: m }
}
let Pi = 0
const Fi = (e) => {
    ...
    Vi = (e, t = '', n = '', r = '') => `${t ? `${t}/` : ''}${n}${e}${r ? `.${r}` : ''}`,
    Ni = (e) => {
        'AbortError' !== e.name && console.error(e.message)
    },
    Di = (e) => (e instanceof HTMLElement ? e : 'string' == typeof e ? document.querySelector(e) : null),
...
function rs(e, t) {
    ...
    const n = { replace: (t, r) => ((r = (r = r.source || r).replace(ns, '$1')), (e = e.replace(t, r)), n), getRegex: () => new RegExp(e, t) }
    return n
}
const ls = /[^\w:]/g,
    is = /^$|^[a-z][a-z0-9+.-]*:|^[?#]/i
function ss(e, t, n) {
    ...
    t &&
        !is.test(n) &&
        (n = (function (e, t) {
            os[' ' + e] || (as.test(e) ? (os[' ' + e] = e + '/') : (os[' ' + e] = hs(e, '/', !0)))
            e = os[' ' + e]
            const n = -1 === e.indexOf(':')
            return '//' === t.substring(0, 2) ? (n ? t : e.replace(cs, '$1') + t) : '/' === t.charAt(0) ? (n ? t : e.replace(us, '$1') + t) : e + t
        })(t, n))
    try {
...
function gs(e, t, n, r) {
    ...
    if ('!' !== e[0].charAt(0)) {
        r.state.inLink = !0
        const e = { type: 'link', raw: n, href: l, title: i, text: s, tokens: r.inlineTokens(s) }
...
class ms {
    ...
    code(e) {
        ...
        if (t) {
            ...
            return { type: 'code', raw: t[0], codeBlockStyle: 'indented', text: this.options.pedantic ? e : hs(e, '\n') }
        }
    }
    fences(e) {
    ...
    list(e) {
        ...
        if (t) {
            let n,
                ...
                f = t[1].trim()
            const g = f.length > 1,
                m = { type: 'list', raw: '', ordered: g, start: g ? +f.slice(0, -1) : '', loose: !1, items: [] }
            ...
            for (; e && ((h = !1), (t = v.exec(e))) && !this.rules.block.hr.test(e); ) {
                if (
                    ...
                    (u = e.split('\n', 1)[0]),
                    this.options.pedantic ? ((i = 2), (d = c.trimLeft())) : ((i = t[2].search(/[^ ]/)), (i = i > 4 ? 1 : i), (d = c.slice(i)), (i += t[1].length)),
                    (o = !1),
                    ...
                    for (
                        ;
                        e &&
                        ((p = e.split('\n', 1)[0]), (u = p), this.options.pedantic && (u = u.replace(/^ {1,4}(?=( {4})*[^ ])/g, '  ')), !l.test(u)) &&
                        !s.test(u) &&
                        !t.test(u) &&
                        !r.test(e);
                ...
                m.loose || (a ? (m.loose = !0) : /\n *\n *$/.test(n) && (a = !0)),
                    this.options.gfm && ((r = /^\[[ xX]\] /.exec(d)), r && ((l = '[ ] ' !== r[0]), (d = d.replace(/^\[[ xX]\] +/, '')))),
                    m.items.push({ type: 'list_item', raw: n, task: !!r, checked: l, loose: !1, text: d }),
                    (m.raw += n)
            }
    ...
    html(e) {
        ...
        if (t) {
            const e = { type: 'html', raw: t[0], pre: !this.options.sanitizer && ('pre' === t[1] || 'script' === t[1] || 'style' === t[1]), text: t[0] }
            if (this.options.sanitize) {
                const n = this.options.sanitizer ? this.options.sanitizer(t[0]) : Yi(t[0])
            ...
            if (e.header.length === e.align.length) {
                ...
                for (n = 0; n < s; n++)
                    /^ *-+: *$/.test(e.align[n])
                        ...
                        ? (e.align[n] = 'left')
                        : (e.align[n] = null)
                for (s = e.rows.length, n = 0; n < s; n++) e.rows[n] = ds(e.rows[n], e.header.length).map((e) => ({ text: e }))
                for (s = e.header.length, r = 0; r < s; r++) e.header[r].tokens = this.lexer.inline(e.header[r].text)
                for (s = e.rows.length, r = 0; r < s; r++) for (i = e.rows[r], l = 0; l < i.length; l++) i[l].tokens = this.lexer.inline(i[l].text)
                return e
            }
        }
    }
        ...
        if (t)
            return (
                    ...
                    : this.lexer.state.inRawBlock && /^<\/(pre|code|kbd|script)(\s|>)/i.test(t[0]) && (this.lexer.state.inRawBlock = !1),
                {
                    ...
                    text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(t[0]) : Yi(t[0])) : t[0]
                }
            )
    }
    link(e) {
        ...
        if (t) {
            ...
            return (
                ...
                gs(t, { href: n ? n.replace(this.rules.inline._escapes, '$1') : n, title: r ? r.replace(this.rules.inline._escapes, '$1') : r }, t[0], this.lexer)
            )
        }
    }
    reflink(e, t) {
    ...
    codespan(e) {
        ...
        if (t) {
            ...
            const n = /[^ ]/.test(e),
                r = /^ /.test(e) && / $/.test(e)
            return n && r && (e = e.substring(1, e.length - 1)), (e = Yi(e, !0)), { type: 'codespan', raw: t[0], text: e }
        }
    }
    br(e) {
    ...
    autolink(e, t) {
        ...
        if (n) {
            let e, r
            return (
                '@' === n[2] ? ((e = Yi(this.options.mangle ? t(n[1]) : n[1])), (r = 'mailto:' + e)) : ((e = Yi(n[1])), (r = e)),
    ...
    url(e, t) {
        ...
        if ((n = this.rules.inline.url.exec(e))) {
            let e, r
            if ('@' === n[2]) (e = Yi(this.options.mangle ? t(n[0]) : n[0])), (r = 'mailto:' + e)
            else {
                let t
                do {
            ...
            return { type: 'link', raw: n[0], text: e, href: r, tokens: [{ type: 'text', raw: e, text: e }] }
        }
    }
    inlineText(e, t) {
...
;(vs.def = rs(vs.def).replace('label', vs._label).replace('title', vs._title).getRegex()),
    (vs.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    ...
    (vs.paragraph = rs(vs._paragraph)
        ...
        .replace('tag', vs._tag)
        .getRegex()),
    (vs.blockquote = rs(vs.blockquote).replace('paragraph', vs.paragraph).getRegex()),
    (vs.normal = { ...vs }),
    (vs.gfm = {
        ...vs.normal,
...
function ks(e) {
    let t,
        ...
        r = ''
    const l = e.length
    for (t = 0; t < l; t++) (n = e.charCodeAt(t)), Math.random() > 0.5 && (n = 'x' + n.toString(16)), (r += '&#' + n + ';')
    return r
}
;(ys._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
    ...
    (ys.emStrong.lDelim = rs(ys.emStrong.lDelim).replace(/punct/g, ys._punctuation).getRegex()),
    (ys.emStrong.rDelimAst = rs(ys.emStrong.rDelimAst, 'g').replace(/punct/g, ys._punctuation).getRegex()),
    (ys.emStrong.rDelimUnd = rs(ys.emStrong.rDelimUnd, 'g').replace(/punct/g, ys._punctuation).getRegex()),
    (ys._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    (ys._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
    (ys._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
    (ys.autolink = rs(ys.autolink).replace('scheme', ys._scheme).replace('email', ys._email).getRegex()),
    (ys._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (ys.tag = rs(ys.tag).replace('comment', ys._comment).replace('attribute', ys._attribute).getRegex()),
    (ys._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    (ys._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
    (ys._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (ys.link = rs(ys.link).replace('label', ys._label).replace('href', ys._href).replace('title', ys._title).getRegex()),
    (ys.reflink = rs(ys.reflink).replace('label', ys._label).replace('ref', vs._label).getRegex()),
    (ys.nolink = rs(ys.nolink).replace('ref', vs._label).getRegex()),
    (ys.reflinkSearch = rs(ys.reflinkSearch, 'g').replace('reflink', ys.reflink).replace('nolink', ys.nolink).getRegex()),
    (ys.normal = { ...ys }),
    (ys.pedantic = {
        ...ys.normal,
    ...
    (ys.gfm.url = rs(ys.gfm.url, 'i').replace('email', ys.gfm._extended_email).getRegex()),
    (ys.breaks = {
        ...ys.gfm,
...
class bs {
    constructor(e) {
        ...
        this.options.pedantic
            ...
            : this.options.gfm && ((t.block = vs.gfm), this.options.breaks ? (t.inline = ys.breaks) : (t.inline = ys.gfm)),
        ...
        for (e = this.options.pedantic ? e.replace(/\t/g, '    ').replace(/^ +$/gm, '') : e.replace(/^( *)(\t+)/gm, (e, t, n) => t + '    '.repeat(n.length)); e; )
            if (
                !(
                    ...
                    this.options.extensions.block.some((r) => !!(n = r.call({ lexer: this }, e, t)) && ((e = e.substring(n.raw.length)), t.push(n), !0))
                )
            )
            ...
            if (e.length > 0)
                for (; null != (i = this.tokenizer.rules.inline.reflinkSearch.exec(a)); )
                    e.includes(i[0].slice(i[0].lastIndexOf('[') + 1, -1)) &&
                        (a = a.slice(0, i.index) + '[' + fs('a', i[0].length - 2) + ']' + a.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
        }
        for (; null != (i = this.tokenizer.rules.inline.blockSkip.exec(a)); )
            a = a.slice(0, i.index) + '[' + fs('a', i[0].length - 2) + ']' + a.slice(this.tokenizer.rules.inline.blockSkip.lastIndex)
        for (; null != (i = this.tokenizer.rules.inline.escapedEmSt.exec(a)); )
            (a = a.slice(0, i.index + i[0].length - 2) + '++' + a.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex)),
        ...
        for (; e; )
            if (
                ...
                !(
                    ...
                    this.options.extensions.inline.some((r) => !!(n = r.call({ lexer: this }, e, t)) && ((e = e.substring(n.raw.length)), t.push(n), !0))
                ))
            )
                if ((n = this.tokenizer.escape(e))) (e = e.substring(n.raw.length)), t.push(n)
                    ...
                    (e = e.substring(n.raw.length)),
                        (r = t[t.length - 1]),
                        r && 'text' === n.type && 'text' === r.type ? ((r.raw += n.raw), (r.text += n.text)) : t.push(n)
                ...
                else if ((n = this.tokenizer.autolink(e, ks))) (e = e.substring(n.raw.length)), t.push(n)
...
class xs {
    ...
    code(e, t, n) {
        ...
        return (
            (e = e.replace(/\n$/, '') + '\n'),
            r
                ? '<pre><code class="' + this.options.langPrefix + Yi(r) + '">' + (n ? e : Yi(e, !0)) + '</code></pre>\n'
    ...
    link(e, t, n) {
        if (null === (e = ss(this.options.sanitize, this.options.baseUrl, e))) return n
        let r = '<a href="' + e + '"'
        ...
        for (n = 0; n < x; n++)
            if (
                ...
                this.options.extensions &&
                    ...
                    ((k = this.options.extensions.renderers[p.type].call({ parser: this }, p)),
                    !1 !== k || !['space', 'hr', 'heading', 'code', 'table', 'blockquote', 'list', 'html', 'paragraph', 'text'].includes(p.type)))
            )
                b += k || ''
            else
                switch (p.type) {
                    ...
                    case 'hr':
                        ...
                        continue
                    case 'heading':
                        b += this.renderer.heading(this.parseInline(p.tokens), p.depth, ts(this.parseInline(p.tokens, this.textRenderer)), this.slugger)
                        continue
                    case 'code':
                    ...
                    case 'table':
                        for (c = '', a = '', i = p.header.length, r = 0; r < i; r++)
                            a += this.renderer.tablecell(this.parseInline(p.header[r].tokens), { header: !0, align: p.align[r] })
                        for (c += this.renderer.tablerow(a), u = '', i = p.rows.length, r = 0; r < i; r++) {
                            for (o = p.rows[r], a = '', s = o.length, l = 0; l < s; l++)
                                a += this.renderer.tablecell(this.parseInline(o[l].tokens), { header: !1, align: p.align[l] })
                    ...
                    case 'blockquote':
                        ...
                        continue
                    case 'list':
                        for (d = p.ordered, h = p.start, f = p.loose, i = p.items.length, u = '', r = 0; r < i; r++)
                            (m = p.items[r]),
                                (v = m.checked),
                                (y = m.task),
                                (g = ''),
                                        ...
                                        ? m.tokens.length > 0 && 'paragraph' === m.tokens[0].type
                                            ? ((m.tokens[0].text = w + ' ' + m.tokens[0].text),
                                              m.tokens[0].tokens &&
                                                  ...
                                                  (m.tokens[0].tokens[0].text = w + ' ' + m.tokens[0].tokens[0].text))
        ...
        for (n = 0; n < s; n++)
            if (
                ...
                this.options.extensions &&
                    ...
                    !1 !== l || !['escape', 'html', 'link', 'image', 'strong', 'em', 'codespan', 'br', 'del', 'text'].includes(r.type)))
            )
                i += l || ''
            else
                switch (r.type) {
    ...
    return (n, r, l) => {
            ...
            s = (function (e, t, n) {
                return (r) => {
                    if (((r.message += '\nPlease report this to https://github.com/markedjs/marked.'), e)) {
                        const e = '<p>An error occurred:</p><pre>' + Yi(r.message + '', !0) + '</pre>'
        ...
        if (
            ...
            const a = function (e) {
                ...
                if (!e)
                    try {
                        r.walkTokens && Rs.walkTokens(o, r.walkTokens), (n = t(o, r)), r.hooks && (n = r.hooks.postprocess(n))
                    } catch (t) {
                        e = t
                    }
        ...
        if (r.async)
            return Promise.resolve(r.hooks ? r.hooks.preprocess(n) : n)
                .then((t) => e(t, r))
                .then((e) => (r.walkTokens ? Promise.all(Rs.walkTokens(e, r.walkTokens)).then(() => e) : e))
                .then((e) => t(e, r))
...
;(Rs.options = Rs.setOptions =
    function (e) {
        var t
        return (Rs.defaults = { ...Rs.defaults, ...e }), (t = Rs.defaults), (qi = t), Rs
    }),
    (Rs.getDefaults = Wi),
    (Rs.defaults = qi),
    (Rs.use = function (...e) {
            ...
            if (e.hooks) {
                ...
                for (const n in e.hooks) {
                    ...
                    Ss.passThroughHooks.has(n)
                        ? (t[n] = (l) => {
                              if (Rs.defaults.async) return Promise.resolve(e.hooks[n].call(t, l)).then((e) => r.call(t, e))
        ...
        for (const r of e)
            switch (((n = n.concat(t.call(Rs, r))), r.type)) {
                case 'table':
                    ...
                    for (const e of r.rows) for (const r of e) n = n.concat(Rs.walkTokens(r.tokens, t))
                    break
                case 'list':
                    n = n.concat(Rs.walkTokens(r.items, t))
                    break
                default:
                    Rs.defaults.extensions && Rs.defaults.extensions.childTokens && Rs.defaults.extensions.childTokens[r.type]
...
const Es = /\$.*?\$/,
    zs = /^\$(.*?)\$/,
    Ls = /^(?:\s{0,3})\$\$((?:[^\n]|\n[^\n])+?)\n{0,1}\$\$/,
    Is = (e = '', t = {}) => e.replace(/:(.+?):/g, (e, n) => (t[n] ? `<img class="wl-emoji" src="${t[n]}" alt="${n}">` : e)),
    Ts = (e, { emojiMap: t, highlighter: n, texRenderer: r }) => {
        if ((Rs.setOptions({ highlight: n || void 0, breaks: !0, smartLists: !0, smartypants: !0 }), r)) {
            const e = ((e) => [
                {
                    name: 'blockMath',
                    level: 'block',
    ...
    Os = ({ serverURL: e, path: t = window.location.pathname, selector: n = '.waline-comment-count', lang: r = navigator.language }) => {
        const l = new AbortController(),
            i = document.querySelectorAll(n)
        return (
            i.length &&
                (({ serverURL: e, lang: t, paths: n, signal: r }) =>
                    fetch(`${e}/comment?type=count&url=${encodeURIComponent(n.join(','))}&lang=${t}`, { signal: r })
                        .then((e) => e.json())
                        .then((e) => (Array.isArray(e) ? e : [e])))({
                    serverURL: E(e),
                    paths: Array.from(i).map((e) => S(e.dataset.path || e.getAttribute('id') || t)),
                    lang: r,
                    signal: l.signal
                })
                    .then((e) => {
    ...
    Us = ({ size: e }) =>
        Ll('svg', { class: 'wl-close-icon', viewBox: '0 0 1024 1024', width: e, height: e }, [
            Ll('path', {
    ...
    qs = ({ size: e = 100 }) =>
        Ll(
            ...
            Ll(
                ...
                Ll('animateTransform', { attributeName: 'transform', type: 'rotate', repeatCount: 'indefinite', dur: '1s', values: '0 50 50;360 50 50', keyTimes: '0;1' })
            )
        ),
    Zs = () =>
        Ll('svg', { width: 24, height: 24, fill: 'currentcolor', viewBox: '0 0 24 24' }, [
            Ll('path', {
                ...
                return function (o) {
                    return (function (i) {
                        ...
                        for (; s; )
                            try {
                                if (
                                    ((n = 1), r && (l = 2 & i[0] ? r.return : i[0] ? r.throw || ((l = r.return) && l.call(r), 0) : r.next) && !(l = l.call(r, i[1])).done)
                                )
                                    return l
...
Object.defineProperty(to, '__esModule', { value: !0 }), (to.ReCaptchaInstance = void 0)
var lo = (function () {
    function e(e, t, n) {
                ...
                return ro(this, function (t) {
                    return [
                        ...
                        this.recaptcha.enterprise
                            ? this.recaptcha.enterprise.execute(this.recaptchaID, { action: e })
...
;(to.ReCaptchaInstance = lo), Object.defineProperty(eo, '__esModule', { value: !0 }), (eo.getInstance = eo.load = void 0)
var io,
    so = to
!(function (e) {
...
var oo = (function () {
    ...
    return (
        ...
        (e.prototype.loadScript = function (t, n, r, l, i) {
            ...
            n && (a = r ? 'https://recaptcha.net/recaptcha/enterprise.js' : 'https://recaptcha.net/recaptcha/api.js'),
        ...
        (e.prototype.doExplicitRender = function (e, t, n, r) {
            var l = { sitekey: t, badge: n.badge, size: n.size, tabindex: n.tabindex }
        ...
        setup(e, { expose: t }) {
            ...
            const n = Js(),
                ...
                a = zl(() => {
                    ...
                    return e.map((e, r) => ({ icon: e, desc: s.value[`reaction${r}`], active: n.value[t] === r }))
                })
            let c
            return (
                Xn(() => {
                    Hn(
                        ...
                        () => {
                            ;(async () => {
                                if (o.value) {
                                    const { serverURL: e, lang: t, path: n, reaction: l } = r.value,
                                        s = new AbortController()
                                    c = s.abort.bind(s)
                                    const o = await _({ serverURL: e, lang: t, paths: [n], type: l.map((e, t) => `reaction${t}`), signal: s.signal })
                ...
                (e, t) =>
                    a.value.length
                        ? (Gr(),
                          Yr('div', po, [
                              sl('div', { class: 'wl-reaction-title', textContent: Ie(s.value.reactionTitle) }, null, 8, ho),
                              sl('ul', fo, [
                                  (Gr(!0),
                                  Yr(
                                      Hr,
                                              ...
                                              Yr(
                                                  'li',
                                                  {
                                                      ...
                                                      onClick: (e) =>
                                                          (async (e) => {
                                                              if (-1 === l.value) {
                                                                  const { serverURL: t, lang: s, path: o } = r.value,
                                                                      a = n.value[o]
                                                                  ;(l.value = e),
                                                                      void 0 !== a &&
                                                                          (await $({ serverURL: t, lang: s, path: o, type: `reaction${a}`, action: 'desc' }),
                                                                          (i.value[a] = Math.max(i.value[a] - 1, 0))),
                                                                      a !== e &&
                                                                          (await $({ serverURL: t, lang: s, path: o, type: `reaction${e}` }),
                                                                          (i.value[e] = (i.value[e] || 0) + 1)),
                                                                      a === e ? delete n.value[o] : (n.value[o] = e),
                                                                      (l.value = -1)
                                                              }
                                                          })(o)
                                                  },
                                                  [
                                                      sl('div', mo, [
                                                          ...
                                                          l.value === o
                                                              ? (Gr(), el(on(qs), { key: 0, class: 'wl-reaction-loading' }))
                                                              : (Gr(), Yr('div', { key: 1, class: 'wl-reaction-votes', textContent: Ie(i.value[o] || 0) }, null, 8, yo))
                                                      ]),
                                                      sl('div', { class: 'wl-reaction-text', textContent: Ie(s) }, null, 8, wo)
                                                  ],
                                                  10,
                                                  go
                                              )
                  ...
                  Array.prototype.forEach.call(e.length ? e : [e], function (e) {
                      return (function (e) {
                          if (e && e.nodeName && 'TEXTAREA' === e.nodeName && !_o.has(e)) {
                              var t,
                                  ...
                                  l =
                                      ((t = e.value),
                                      function () {
                                          s({ testForHeightReduction: '' === t || !e.value.startsWith(t), restoreTextAlign: null }), (t = e.value)
                                      }),
                                  i = function (t) {
                          ...
                          function s(t) {
                              ...
                              if (
                                  0 !== e.scrollHeight &&
                                  ('vertical' === r.resize ? (e.style.resize = 'none') : 'both' === r.resize && (e.style.resize = 'horizontal'),
                                  u &&
                                      ((l = (function (e) {
                                  ...
                                  'none' !== r.maxHeight && i > parseFloat(r.maxHeight)
                                      ? ('hidden' === r.overflowY && (e.style.overflow = 'scroll'), (i = parseFloat(r.maxHeight)))
                                      : 'hidden' !== r.overflowY && (e.style.overflow = 'hidden'),
                                  (e.style.height = i + 'px'),
                                  a && (e.style.textAlign = a),
                                  l && l(),
                                  n !== i && (e.dispatchEvent(new Event('autosize:resized', { bubbles: !0 })), (n = i)),
                                  p !== r.overflow && !a)
                              ) {
                                  var d = r.textAlign
                                  'hidden' === r.overflow && (e.style.textAlign = 'start' === d ? 'end' : 'start'), s({ restoreTextAlign: d, testForHeightReduction: !0 })
                              }
                          }
                          function o() {
...
var zo = Kn({
        ...
        setup(e, { expose: t }) {
            ...
            const l = nn(null),
                ...
                s = nn([]),
                o = () => {
                    const e = Math.floor((l.value.getBoundingClientRect().width + n.gap) / (n.columnWidth + n.gap))
                    return e > 0 ? e : 1
                },
                a = async (e) => {
                    if (e >= n.items.length) return
                    await _n()
                    const t = Array.from(l.value?.children || []).reduce((e, t) => (t.getBoundingClientRect().height < e.getBoundingClientRect().height ? t : e))
            ...
            return (
                ...
                (e, t) => (
                    ...
                    Yr(
                        'div',
                        { ref_key: 'wall', ref: l, class: 'wl-gallery', style: xe({ gap: `${e.gap}px` }) },
                        [
                            (Gr(!0),
                            Yr(
                                Hr,
                                ...
                                ir(
                                    ...
                                    (t, n) => (
                                        ...
                                        Yr(
                                            'div',
                                            { key: n, class: 'wl-gallery-column', 'data-index': n, style: xe({ gap: `${e.gap}px` }) },
                                            [
                                                (Gr(!0),
                                                Yr(
                                                    Hr,
                                                            ...
                                                            Yr(
                                                                ...
                                                                [
                                                                    i.value[e.items[t].src]
                                                                        ? ul('v-if', !0)
                                                                        : (Gr(), el(on(qs), { key: 0, size: 36, style: { margin: '20px auto' } })),
                                                                    sl(
                                                                        'img',
                                                                        {
            ...
            const l = xr('config'),
                ...
                j = (e) => {
                    const t = c.value,
                        ...
                        r = t.selectionEnd || 0,
                        l = t.scrollTop
                    ;(i.value = t.value.substring(0, n) + e + t.value.substring(r, t.value.length)),
                        t.focus(),
                ...
                N = async () => {
                    const { serverURL: e, lang: t, login: u, wordLimit: p, requiredMeta: d, recaptchaV3Key: h, turnstileKey: f } = l.value,
                        g = await (async () => {
                            if (!navigator) return ''
                        ...
                        v = { comment: R.value, nick: s.value.nick, mail: s.value.mail, link: s.value.link, url: l.value.path, ua: g }
                    if (o.value?.token) (v.nick = o.value.display_name), (v.mail = o.value.email), (v.link = o.value.url)
                        ...
                        if ((d.indexOf('mail') > -1 && !v.mail) || (v.mail && ((y = v.mail), !O.test(y)))) return a.value.mail?.focus(), alert(L.value.mailError)
                        v.nick || (v.nick = L.value.anonymous)
                    }
                    var y
                    if (v.comment) {
                        if (!S.value) return alert(L.value.wordHint.replace('$0', p[0].toString()).replace('$1', p[1].toString()).replace('$2', x.value.toString()))
                        ;(v.comment = Is(v.comment, m.value.map)),
                            r.replyId && r.rootId && ((v.pid = r.replyId), (v.rid = r.rootId), (v.at = r.replyUser)),
                            (E.value = !0)
                        try {
                            h &&
                                (v.recaptchaV3 = await ((e) => {
                                    const t = ao[e] ?? (ao[e] = Ys.load(e, { useRecaptchaNet: !0, autoHideBadge: !0 }))
                                ...
                                f &&
                                    ...
                                    {
                                        execute: async (e) => {
                                            const { load: t } = Mi('https://challenges.cloudflare.com/turnstile/v0/api.js', void 0, { async: !1 })
                                            await t()
                                            const n = window?.turnstile
                                            return new Promise((t) => {
                                                n?.ready(() => {
                                                    n?.render('.wl-captcha-container', { sitekey: w, action: e, size: 'compact', callback: t })
                                                })
                                            })
                                        }
                                    }).execute('social'))
                            const l = { serverURL: e, lang: t, token: o.value?.token, comment: v },
                                s = await (r.edit
                                    ...
                                    : (({ serverURL: e, lang: t, token: n, comment: r }) => {
                                          ...
                                          return (
                                              ...
                                              fetch(`${e}/comment?lang=${t}`, { method: 'POST', headers: l, body: JSON.stringify(r) }).then((e) => e.json())
                                          )
                                      })(l))
                            if (((E.value = !1), s.errmsg)) return alert(s.errmsg)
                            n('submit', s.data), (i.value = ''), (b.value = ''), r.replyId && n('cancelReply'), r.edit?.objectId && n('cancelEdit')
                        } catch (e) {
                            ...
                            new Promise((e) => {
                                const t = ({ data: n }) => {
                                    n &&
                                        ...
                                        'userInfo' === n.type &&
                                        n.data.token &&
                                        (l?.close(), window.removeEventListener('message', t), e(n.data))
                                }
                                window.addEventListener('message', t)
                            })
                        )
                    })({ serverURL: r, lang: t }).then((e) => {
                        ;(o.value = e), (e.remember ? localStorage : sessionStorage).setItem('WALINE_USER', JSON.stringify(e)), n('log')
                    })
                },
                H = () => {
                ...
                W = (e) => {
                    p.value?.contains(e.target) || d.value?.contains(e.target) || (y.value = !1),
                        h.value?.contains(e.target) || f.value?.contains(e.target) || (w.value = !1)
                },
                q = async (e) => {
                    ...
                    _.loading = !0
                    ;(s.more && _.list.length ? await s.more(o, _.list.length) : await s.search(o)).length
                        ? (_.list = [..._.list, ...(s.more && _.list.length ? await s.more(o, _.list.length) : await s.search(o))])
                        : (z.value = !0),
                        (_.loading = !1),
                        setTimeout(() => {
                    ...
                    document.body.addEventListener('click', W),
                        ...
                        Hn(
                            ...
                            (e) => {
                                ...
                                ;(R.value = e),
                                    (b.value = Ts(e, { emojiMap: m.value.map, highlighter: t, texRenderer: n })),
                                    (x.value = ((e) =>
                                        (((e) => e.match(/[\w\d\s,.\u00C0-\u024F\u0400-\u04FF]+/giu))(e)?.reduce(
                                            (e, t) => e + ('' === t.trim() ? 0 : t.trim().split(/\s+/u).length),
                                            0
                                        ) || 0) + (((e) => e.match(/[\u4E00-\u9FD5]/gu))(e)?.length || 0))(e)),
                        ...
                        Hn(
                            ...
                            (e) => {
                                return ((t = e),
                                Promise.all(t.map((e) => ('string' == typeof e ? Fi(A(e)) : Promise.resolve(e)))).then((e) => {
                                    const t = { tabs: [], map: {} }
                                    return (
                                        e.forEach((e) => {
                                            const { name: n, folder: r, icon: l, prefix: i, type: s, items: o } = e
                                            t.tabs.push({
                                                name: n,
                                                icon: Vi(l, r, i, s),
                                                items: o.map((e) => {
                    ...
                    Yr('div', Io, [
                        'disable' !== on(l).login && I.value && !e.edit?.objectId
                            ? (Gr(),
                              Yr('div', To, [
                                  sl('div', jo, [
                                      sl('button', { type: 'submit', class: 'wl-logout-btn', title: L.value.logout, onClick: H }, [ol(on(Us), { size: 14 })], 8, Oo),
                                      sl(
                                          'a',
                                          { href: '#', class: 'wl-login-nick', 'aria-label': 'Profile', title: L.value.profile, onClick: B },
                                          [sl('img', { src: on(o).avatar, alt: 'avatar' }, null, 8, Mo)],
                                          8,
                                          Uo
                                      )
                                  ]),
                        ...
                        sl('div', Fo, [
                            'force' !== on(l).login && on(l).meta.length && !I.value
                                ? (Gr(),
                                  Yr(
                                      'div',
                                      { key: 0, class: Ae(['wl-header', `item${on(l).meta.length}`]) },
                                      [
                                          (Gr(!0),
                                          Yr(
                                              Hr,
                                                      ...
                                                      Yr('div', { key: e, class: 'wl-header-item' }, [
                                                          sl(
                                                              'label',
                                                              {
                                                                  ...
                                                                  textContent: Ie(
                                                                      L.value[e] +
                                                                          (on(l).requiredMeta.includes(e) || !on(l).requiredMeta.length ? '' : `(${L.value.optional})`)
                                                                  )
                                                              },
                                                              null,
                                                              8,
                            ...
                            qn(
                                sl(
                                    'div',
                                    Ho,
                                    [Bo, sl('h4', null, Ie(L.value.preview) + ':', 1), sl('div', { class: 'wl-content', innerHTML: b.value }, null, 8, Wo)],
                                    512
                                ),
                                [[ci, k.value]]
                            ),
                            sl('div', qo, [
                                sl('div', Zo, [
                                        ...
                                        ? (Gr(),
                                          Yr(
                                              'button',
                                              {
                                                  ...
                                                  ref: h,
                                                  type: 'button',
                                                  class: Ae(['wl-action wl-hiden', { active: w.value }]),
                                                  title: L.value.gif,
                                    ...
                                    T.value
                                        ? (Gr(), Yr('label', { key: 1, for: 'wl-image-upload', class: 'wl-action', title: L.value.uploadImage }, [ol(on(Fs))], 8, Jo))
                                        : ul('v-if', !0),
                                    sl(
                                        'button',
                                        {
                                ...
                                sl('div', Yo, [
                                    ...
                                    sl('div', ta, [
                                        ...
                                        on(l).wordLimit
                                            ? (Gr(),
                                              Yr('span', na, [cl('  /  '), sl('span', { class: Ae({ illegal: !S.value }), textContent: Ie($.value) }, null, 10, ra)]))
                                            : ul('v-if', !0),
                                        cl('  ' + Ie(L.value.word), 1)
                                    ]),
                                    'disable' === on(l).login || I.value
                                        ? ul('v-if', !0)
                                        : (Gr(), Yr('button', { key: 0, type: 'button', class: 'wl-btn', onClick: D, textContent: Ie(L.value.login) }, null, 8, la)),
                                    'force' !== on(l).login || I.value
                                        ? (Gr(),
                                          Yr(
                                              'button',
                                              { key: 1, type: 'submit', class: 'primary wl-btn', title: 'Cmd|Ctrl + Enter', disabled: E.value, onClick: N },
                                              [E.value ? (Gr(), el(on(qs), { key: 0, size: 16 })) : (Gr(), Yr(Hr, { key: 1 }, [cl(Ie(L.value.submit), 1)], 64))],
                                              8,
                                              ia
                                          ))
                                        : ul('v-if', !0)
                                ...
                                sl(
                                    'div',
                                    { ref_key: 'gifPopupRef', ref: f, class: Ae(['wl-gif-popup', { display: w.value }]) },
                                    [
                                        sl(
                                            'input',
                                            {
                                        ...
                                        _.list.length
                                            ? (Gr(),
                                              el(
                                                  Lo,
                                                  { key: 0, items: _.list, 'column-width': 200, gap: 6, onInsert: t[5] || (t[5] = (e) => j(e)), onScroll: q },
                                                  null,
                                                  8,
                                                  ['items']
                                              ))
                                            : ul('v-if', !0),
                                        _.loading ? (Gr(), Yr('div', oa, [ol(on(qs), { size: 30 })])) : ul('v-if', !0)
                                    ],
                                    2
                                ),
                                sl(
                                    'div',
                                    { ref_key: 'emojiPopupRef', ref: d, class: Ae(['wl-emoji-popup', { display: y.value }]) },
                                    [
                                        (Gr(!0),
                                        Yr(
                                            Hr,
                                                                      ...
                                                                      Yr(
                                                                          ...
                                                                          ir(
                                                                              ...
                                                                              (e) => (
                                                                                  ...
                                                                                  Yr(
                                                                                      'button',
                                                                                      { key: e, type: 'button', title: e, onClick: (t) => j(`:${e}:`) },
                                                                                      [
                                                                                          y.value
                                                                                              ? (Gr(),
                                                                                                Yr(
                                                          ...
                                                          (e, t) => (
                                                              ...
                                                              Yr(
                                                                  'button',
                                                                  {
                                                                      key: e.name,
                                                                      type: 'button',
                                                                      class: Ae(['wl-tab', { active: v.value === t }]),
                                                                      onClick: (e) => (v.value = t)
                                                                  },
                                                                  [
                                                                      sl(
            ...
            return (e, t) => {
                ...
                return (
                    ...
                    Yr(
                        ...
                        [
                            sl('div', ya, [
                                e.comment.avatar ? (Gr(), Yr('img', { key: 0, src: e.comment.avatar }, null, 8, wa)) : ul('v-if', !0),
                                e.comment.type ? (Gr(), el(on(Ws), { key: 1 })) : ul('v-if', !0)
                            ]),
                            sl('div', ka, [
                                sl('div', ba, [
                                    a.value
                                        ? (Gr(),
                                          Yr(
                                              'a',
                                              { key: 0, class: 'wl-nick', href: a.value, target: '_blank', rel: 'nofollow noopener noreferrer' },
                                              Ie(e.comment.nick),
                                              9,
                                              xa
                                          ))
                                    ...
                                    'administrator' === e.comment.type
                                        ? (Gr(), Yr('span', { key: 2, class: 'wl-badge', textContent: Ie(o.value.admin) }, null, 8, $a))
                                        : ul('v-if', !0),
                                    e.comment.label ? (Gr(), Yr('span', { key: 3, class: 'wl-badge', textContent: Ie(e.comment.label) }, null, 8, Ca)) : ul('v-if', !0),
                                    e.comment.sticky ? (Gr(), Yr('span', { key: 4, class: 'wl-badge', textContent: Ie(o.value.sticky) }, null, 8, Sa)) : ul('v-if', !0),
                                    void 0 !== e.comment.level && e.comment.level >= 0
                                        ...
                                        : ul('v-if', !0),
                                    sl('span', { class: 'wl-time', textContent: Ie(u.value) }, null, 8, Ra),
                                    sl('div', Ea, [
                                        p.value || d.value
                                            ? (Gr(),
                                              Yr('button', { key: 0, type: 'button', class: 'wl-edit', onClick: t[0] || (t[0] = () => e.$emit('edit', e.comment)) }, [
                                                  ol(on(Bs))
                                              ]))
                                            : ul('v-if', !0),
                                        p.value || d.value
                                            ? (Gr(),
                                              Yr(
                                                  'button',
                                                  { key: 1, type: 'button', class: 'wl-delete', onClick: t[1] || (t[1] = (t) => e.$emit('delete', e.comment)) },
                                                  [ol(on(Ms))]
                                              ))
                                            : ul('v-if', !0),
                                        sl(
                                            ...
                                            [
                                                ...
                                                'like' in e.comment ? (Gr(), Yr('span', { key: 0, textContent: Ie(e.comment.like) }, null, 8, La)) : ul('v-if', !0)
                                            ],
                                            8,
                                            za
                                        ),
                                ...
                                sl('div', Ta, [
                                    e.comment.addr
                                        ? (Gr(), Yr('span', { key: 0, class: 'wl-addr', 'data-value': e.comment.addr, textContent: Ie(e.comment.addr) }, null, 8, ja))
                                        : ul('v-if', !0),
                                    e.comment.browser
                                        ? (Gr(),
                                          Yr('span', { key: 1, class: 'wl-browser', 'data-value': e.comment.browser, textContent: Ie(e.comment.browser) }, null, 8, Oa))
                                        : ul('v-if', !0),
                                    e.comment.os
                                        ? (Gr(), Yr('span', { key: 2, class: 'wl-os', 'data-value': e.comment.os, textContent: Ie(e.comment.os) }, null, 8, Ua))
                                        : ul('v-if', !0)
                                ]),
                                f.value ? ul('v-if', !0) : (Gr(), Yr('div', { key: 0, class: 'wl-content', innerHTML: e.comment.comment }, null, 8, Ma)),
                                p.value && !f.value
                                    ? (Gr(),
                                      Yr('div', Pa, [
                                          sl('span', Fa, [
                                                  ...
                                                  ir(n, (t) =>
                                                      sl(
                                                          'button',
                                                          {
                                                              ...
                                                              onClick: (n) => e.$emit('status', { status: t, comment: e.comment }),
                                          ...
                                          p.value && !e.comment.rid
                                              ? (Gr(),
                                                Yr(
                                                    'button',
                                                    { key: 0, type: 'submit', class: 'wl-btn wl-sticky', onClick: t[4] || (t[4] = (t) => e.$emit('sticky', e.comment)) },
                                                    Ie(e.comment.sticky ? o.value.unsticky : o.value.sticky),
                                                    1
                                                ))
                                              : ul('v-if', !0)
                                      ]))
                                ...
                                h.value || f.value
                                    ? (Gr(),
                                      Yr(
                                          'div',
                                          { key: 2, class: Ae({ 'wl-reply-wrapper': h.value, 'wl-edit-wrapper': f.value }) },
                                          [
                                              ol(
                                                  ma,
                                                  {
...
const Ha = '2.15.8',
    ...
    lc = sl('a', { href: 'https://github.com/walinejs/waline', target: '_blank', rel: 'noopener noreferrer' }, ' Waline ', -1)
var ic = Kn({
        ...
        setup(e) {
            const a = e,
                c = { latest: 'insertedAt_desc', oldest: 'insertedAt_asc', hottest: 'like_desc' },
                u = Object.keys(c),
                d = uo(),
                h = Gs(),
                f = nn('loading'),
            ...
            !(function (e, t = {}) {
                const n = nn(!1),
                    { document: r = Ai, immediate: l = !0, manual: i = !1, id: s = 'vueuse_styletag_' + ++Pi } = t,
                    o = nn(e)
                let a = () => {}
                const c = () => {
                        if (!r) return
                        const e = r.getElementById(s) || r.createElement('style')
                        e.isConnected || ((e.id = s), t.media && (e.media = t.media), r.head.appendChild(e)),
                            n.value ||
                                ((a = Hn(
                                    o,
                                    (t) => {
            ...
            const j = (e) => {
                    ...
                    ;(f.value = 'loading'),
                        T?.(),
                        (({ serverURL: e, lang: t, path: n, page: r, pageSize: l, sortBy: i, signal: s, token: o }) => {
                            const a = {}
                            return (
                                o && (a.Authorization = `Bearer ${o}`),
                                fetch(`${e}/comment?path=${encodeURIComponent(n)}&pageSize=${l}&page=${r}&lang=${t}&sortBy=${i}`, { signal: s, headers: a })
                                    .then((e) => e.json())
                                    .then((e) => x(e, 'Get comment data'))
                            )
                        })({ serverURL: t, lang: y.value.lang, path: n, pageSize: r, sortBy: c[w.value], page: e, signal: l.signal, token: d.value?.token })
                            .then((t) => {
                                ;(f.value = 'success'), (g.value = t.count), b.value.push(...t.data), (m.value = e), (v.value = t.totalPages)
                            })
                            .catch((e) => {
                ...
                V = async ({ comment: e, status: t }) => {
                    ...
                    await C({ serverURL: n, lang: r, token: d.value?.token, objectId: e.objectId, comment: { status: t } }), (e.status = t)
                },
                N = async (e) => {
                    if (e.rid) return
                    const { serverURL: t, lang: n } = y.value
                    await C({ serverURL: t, lang: n, token: d.value?.token, objectId: e.objectId, comment: { sticky: e.sticky ? 0 : 1 } }), (e.sticky = !e.sticky)
                },
                D = async ({ objectId: e }) => {
                    if (!confirm('Are you sure you want to delete this comment?')) return
                    const { serverURL: t, lang: n } = y.value
                    await (({ serverURL: e, lang: t, token: n, objectId: r }) =>
                        fetch(`${e}/comment/${r}?lang=${t}`, { method: 'DELETE', headers: { Authorization: `Bearer ${n}` } })
                            .then((e) => e.json())
                            .then((e) => x(e, 'Delete comment')))({ serverURL: t, lang: n, token: d.value?.token, objectId: e }),
                        b.value.some((t, n) =>
                            t.objectId === e
                                ? ((b.value = b.value.filter((e, t) => t !== n)), !0)
                                : t.children.some((r, l) => r.objectId === e && ((b.value[n].children = t.children.filter((e, t) => t !== l)), !0))
                        )
                },
                H = async (e) => {
                    const { serverURL: t, lang: n } = y.value,
                    ...
                    await C({ serverURL: t, lang: n, objectId: r, token: d.value?.token, comment: { like: !l } }),
                        l ? (h.value = h.value.filter((e) => e !== r)) : ((h.value = [...h.value, r]), h.value.length > 50 && (h.value = h.value.slice(-50))),
            ...
            return (
                ...
                (e, t) => (
                    ...
                    Yr('div', Ba, [
                        ol(xo),
                        _.value ? ul('v-if', !0) : (Gr(), el(ma, { key: 0, onLog: U, onSubmit: F })),
                        sl('div', Wa, [
                            sl('div', qa, [
                                g.value ? (Gr(), Yr('span', { key: 0, class: 'wl-num', textContent: Ie(g.value) }, null, 8, Za)) : ul('v-if', !0),
                        ...
                        'error' === f.value
                            ? (Gr(), Yr('div', Ja, [sl('button', { type: 'button', class: 'wl-btn', onClick: U, textContent: Ie(R.value.refresh) }, null, 8, Xa)]))
                            : (Gr(),
                              Yr(
                                  Hr,
                                  { key: 2 },
                                  [
                                      'loading' === f.value
                                          ...
                                          ? m.value < v.value
                                              ? (Gr(),
                                                Yr('div', tc, [
                                                    sl('button', { type: 'button', class: 'wl-btn', onClick: O, textContent: Ie(R.value.more) }, null, 8, nc)
                                                ]))
                                              : ul('v-if', !0)
                                          : (Gr(), Yr('div', { key: 1, class: 'wl-empty', textContent: Ie(R.value.sofa) }, null, 8, ec))
                                  ],
                                  64
                              )),
                        y.value.copyright ? (Gr(), Yr('div', rc, [cl(' Powered by '), lc, cl(' v' + Ie(on(Ha)), 1)])) : ul('v-if', !0)
                    ])
                )
            )
        }
...
const oc = (e, t) => {
    ...
    ac = ({ serverURL: e, path: t = window.location.pathname, selector: n = '.waline-pageview-count', update: r = !0, lang: l = navigator.language }) => {
        const i = new AbortController(),
            ...
            a = (n) =>
                (({ serverURL: e, lang: t, paths: n, signal: r }) =>
                    _({ serverURL: e, lang: t, paths: n, type: ['time'], signal: r }).then((e) => (Array.isArray(e) ? e : [e])))({
                    serverURL: E(e),
        ...
        if (r) {
            const n = s.filter((e) => !o(e)),
                r = s.filter(o)
            ;((c = { serverURL: E(e), path: t, lang: l }), $({ ...c, type: 'time', action: 'inc' })).then((e) => oc(new Array(n.length).fill(e), n)), r.length && a(r)
        } else a(s)
        var c
        return i.abort.bind(i)
    },
    cc = ({ el: e = '#waline', path: t = window.location.pathname, comment: n = !1, pageview: r = !1, ...l }) => {
        const i = e ? Di(e) : null
        ...
        a && a.mount(i)
        const c = Nn(() => {
                o.comment && Os({ serverURL: s.serverURL, path: o.path, selector: 'string' == typeof o.comment ? o.comment : void 0 })
            }),
            u = Nn(() => {
                o.pageview && ac({ serverURL: s.serverURL, path: o.path, selector: 'string' == typeof o.pageview ? o.pageview : void 0 })
            })
        return {
            el: i,
            update: ({ comment: e, pageview: t, path: n = window.location.pathname, ...r } = {}) => {
    ...
    uc = ({ el: e, serverURL: t, count: n, lang: r = navigator.language }) => {
        ...
        return (({ serverURL: e, lang: t, count: n, signal: r, token: l }) => {
            const i = {}
            return l && (i.Authorization = `Bearer ${l}`), fetch(`${e}/comment?type=recent&count=${n}&lang=${t}`, { signal: r, headers: i }).then((e) => e.json())
        })({ serverURL: t, count: n, lang: r, signal: s.signal, token: l.value?.token }).then((e) =>
            i && e.length
                ? ((i.innerHTML = `<ul class="wl-recent-list">${e
                      .map((e) => `<li class="wl-recent-item"><a href="${e.url}">${e.nick}</a>：${e.comment}</li>`)
                      .join('')}</ul>`),
                  {
                      comments: e,
                      destroy: () => {
    ...
    pc = ({ el: e, serverURL: t, count: n, locale: l, lang: i = navigator.language, mode: s = 'list' }) => {
        const o = Di(e),
        ...
        return (({ serverURL: e, signal: t, pageSize: n, lang: r }) =>
            fetch(`${e}/user?pageSize=${n}&lang=${r}`, { signal: t })
                ...
                .then((e) => e.data))({ serverURL: t, pageSize: n, lang: i, signal: a.signal }).then((e) =>
            o && e.length
                  ...
                  (o.innerHTML = `<ul class="wl-user-${s}">${e
                      .map((e, t) =>
                          [
                              ...
                              e.nick,
                              e.level && `<span class="wl-badge">${l ? l[`level${e.level}`] : `Level ${e.level}`}</span>`,
...
export { uc as RecentComments, pc as UserList, Os as commentCount, k as defaultLocales, cc as init, ac as pageviewCount, Ha as version }
